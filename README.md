...
Endpoint for sender service: <br />
    ...
    This endpoint takes in the image path that needs to be classified, and send it to the model server, the response is then stored in the message broker <br />
